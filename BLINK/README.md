README.md
<b>BLINK</b><br>
<p>BLINK is a simple utility that reads a word from the switch register and rotates that pattern in the Accumulator lights on the front panel. Be sure to rotate the front panel switch to display the AC register.</p></br>
