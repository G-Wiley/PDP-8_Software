...
<P>Note that the inputs to J2 on the M862 board are active low, so a low level on J2 will appear as a logic one in the AC register and in the AC lights. The inputs on J2 are pulled high, so a disconnected J2 will be read as all-zero.</P>
